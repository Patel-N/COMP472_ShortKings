...
def solvePuzzle(puzzleString, puzzleNum:int):
    ...
    ucs_state, ucs_details, search_time, stateSearchCount = GBFS(grid, 'h1')
    generateOutputFiles(dir, 'GBFS',  puzzleNum, puzzleString, ucs_state, ucs_details, search_time, stateSearchCount)
